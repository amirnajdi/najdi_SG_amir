    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form method="get" action="index.php?route=/&lang=en" class="disableAjax">
          <input type="hidden" name="route" value="/export"><input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="772c6b7a43727b5961217b2d22214422">
...
<form method="post" id="login_form" action="index.php?route=/" name="login_form" class="disableAjax hide js-show">
    <input type="hidden" name="route" value="/export"><input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="772c6b7a43727b5961217b2d22214422">
  <input type="hidden" name="set_session" value="9e0d2814ef71defc1748f8b44b24b855">
